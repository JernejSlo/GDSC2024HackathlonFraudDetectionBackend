...
class UpdateUserModelService(GeneralCalculationService):
    ...
    def updateUserModel(self):
        try:
            DataProcessingUtils("./Tests/transactions.csv","UserId","./Tests/users.csv").extract_and_update_user_model(self.transaction)
        except Exception as e:

            raise e
        return {"Status": "Success", "Message": "User model was updated successfully."}
